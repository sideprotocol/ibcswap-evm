...
export declare namespace IBlockScopePayment {
  export type TierStruct = {
    name: PromiseOrValue<string>;
    price: PromiseOrValue<BigNumberish>;
  };

  export type TierStructOutput = [string, BigNumber] & {
    name: string;
    price: BigNumber;
  };
  ...
  export type PaymentStructOutput = [string, string, BigNumber, BigNumber] & {
    payer: string;
    token: string;
    tierIndex: BigNumber;
    nonce: BigNumber;
...
export interface BlockScopePaymentV2Interface extends utils.Interface {
  functions: {
    ...
    "payWithSignature((address,address,uint256,uint256),bytes)": FunctionFragment;
    "proxiableUUID()": FunctionFragment;
    "removeAdmin(address)": FunctionFragment;
    "removePauser(address)": FunctionFragment;
    "renounceRole(bytes32,address)": FunctionFragment;
    "revokeRole(bytes32,address)": FunctionFragment;
    "scopeToken()": FunctionFragment;
    "setDAOTreasury(address)": FunctionFragment;
    "setPaginationSize(uint256)": FunctionFragment;
    "setTierPrice(uint256,(string,uint256))": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [IBlockScopePayment.PaymentStruct, PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, IBlockScopePayment.TierStruct]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "scopeToken", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "setDAOTreasury",
    data: BytesLike
  ): Result;
...
export interface BlockScopePaymentV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BlockScopePaymentV2Interface;
  ...
  functions: {
    ...
    initialize(
      ...
      _daoTreasury: PromiseOrValue<string>,
      _scopeToken: PromiseOrValue<string>,
      _oracle: PromiseOrValue<string>,
      _tiers: IBlockScopePayment.TierStruct[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    payWithSignature(
      payment: IBlockScopePayment.PaymentStruct,
    ...
    scopeToken(overrides?: CallOverrides): Promise<[string]>;
    ...
    setTierPrice(
      ...
      newTier: IBlockScopePayment.TierStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    scopeToken(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    scopeToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
