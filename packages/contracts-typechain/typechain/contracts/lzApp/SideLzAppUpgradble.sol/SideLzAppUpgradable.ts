...
export interface SideLzAppUpgradableInterface extends utils.Interface {
  functions: {
    ...
    "setPacketReceivers(address,address)": FunctionFragment;
...
export interface SideLzAppUpgradable extends BaseContract {
  ...
  functions: {
    ...
    setPacketReceivers(
      _atomicswap: PromiseOrValue<string>,
      _interchainswap: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
